    <?php /* Template Name: Recorridos Portugues */ ?>
    <?php get_header('portugues'); ?>
    <!-- CONTENIDO RECORRIDOS-PORTUGUES.PHP -->
    <div id="main">
        ...
        <div class="container-fluid catalogo-museos">
          <div class="container">
            <div class="row container-titulo">
              <div class="col-12">
                <h1>Catálogo</h1>
                <p class="bajada">Selecione o seu museu para ouvir o guia áudio</p>
              </div>
            </div>
            <div class="row imagenes-catalogo icono">
              <?php query_posts(array('post_type' => 'post', 'lang' => 'pt', 'posts_per_page' => 6, 'category_name' => 'tours-de-som-portugues'));
      ...
      <section id="como-recorrer" style="background-color: #fff;">
        <div class="container ">
          ...
          <div class="row seccion-pasos">
            <?php query_posts(array('post_type' => 'post', 'lang' => 'pt', 'posts_per_page' => 6, 'category_name' => 'como-ouvir-portugues'));
            while (have_posts()) : the_post(); ?>
