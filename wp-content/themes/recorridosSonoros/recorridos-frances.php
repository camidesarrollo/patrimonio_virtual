    <?php /* Template Name: Recorridos Frances */ ?>
    <?php get_header('frances'); ?>
    <!-- CONTENIDO RECORRIDOS-FRANCES.PHP -->
    <div id="main">
        ...
        <div class="container-fluid catalogo-museos">
          <div class="container">
            <div class="row container-titulo">
              <div class="col-12">
                <h1>Catalogue</h1>
                <p class="bajada">Sélectionnez votre musée pour écouter son audioguide</p>
              </div>
            </div>
            <div class="row imagenes-catalogo icono">
              <?php query_posts(array('post_type' => 'post', 'lang' => 'fr', 'posts_per_page' => 6, 'category_name' => 'visites-sonores-frances'));
      ...
      <section id="como-recorrer" style="background-color: #fff;">
        <div class="container ">
          <div class="row container-titulo">
            <div class="col-12">
              <h1>Comment écouter?</h1>
            </div>
          </div>
          <div class="row seccion-pasos">
            <?php query_posts(array('post_type' => 'post', 'lang' => 'fr', 'posts_per_page' => 2, 'category_name' => 'comment-ecouter-frances'));
            while (have_posts()) : the_post(); ?>
