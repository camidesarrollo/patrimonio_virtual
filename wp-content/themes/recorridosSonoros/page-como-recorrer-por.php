<?php
/*
 * Template Name: Como recorrer portugués
...
<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
    ...
    <div id="main">
            ...
            <section id="como-recorrer">
                <div class="container ">
                    <div class="row container-titulo">
                        <div class="col-12">
                            <h1>Como navegar no tour virtual?</h1>
                        </div>
                    </div>  
            ...
            <section id="opciones" style="background-color: #EEEEEE;">
                <div class="container ">
                    ...
                    <div class="row d-flex justify-content-center contenedor-boton-central" style="padding-top: 1.6875rem; padding-bottom: 3rem;">
                        <div class="col-12  text-center boton-central" onclick="window.location='/pt/tours-virtuais/';">
                            Ir para passeios
                        </div>        
                    </div>
                </div>
        ...
        <div class="container ">
          <div class="row container-titulo">
            <div class="col-12">
              <h1>Como ouvir as turnês de som?</h1>
            </div>
          </div>  
          <div class="row seccion-pasos">
            <?php query_posts(array('post_type' => 'post','lang' => 'pt','posts_per_page' => 2,'category_name' => 'como-ouvir-portugues')); 
