<?php
/*
 * Template Name: Como recorrer frances
...
<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
    ...
    <div id="main">
            ...
            <section id="como-recorrer">
                <div class="container ">
                    <div class="row container-titulo">
                        <div class="col-12">
                            <!--h1><?php //the_title(); ?></h1-->
                            <h1>Comment naviguer dans la visite virtuelle ?</h1>
                        </div>
                    </div>  
            ...
            <section id="opciones" style="background-color: #EEEEEE;">
                <div class="container ">
                    ...
                    <div class="row d-flex justify-content-center contenedor-boton-central" style="padding-top: 1.6875rem; padding-bottom: 3rem;">
                        <div class="col-12  text-center boton-central" onclick="window.location='/fr/visites-virtuelles/';">
                            Aller aux visites
                        </div>        
                    </div>
                </div>
        ...
        <div class="container ">
          <div class="row container-titulo">
            <div class="col-12">
              <h1>Comment écouter les tournées sonores ?</h1>
            </div>
          </div>  
          <div class="row seccion-pasos">
