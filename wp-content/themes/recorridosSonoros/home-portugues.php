    <?php /* Template Name: HOME PORTUGUES */ ?>
        ...
        <div class="container-fluid catalogo-museos">
          <div class="container">
            ...
            <div class="row imagenes-catalogo">
              <?php query_posts(array('post_type' => 'post','lang' => 'pt','category_name' => 'tours-virtuais','posts_per_page' => 3)); 
              $postCount=0;
            ...
            <div class="row d-flex justify-content-center contenedor-boton-central" style="padding-top: 1.6875rem; padding-bottom: 3rem;">
              <div class="col-12  text-center boton-central">
                <a href="/tours-virtuais/" style="color: white !important;">Veja todos os passeios virtuais</a>
              </div>        
            </div>
          </div>
        </div>
      ...
      <section id="como-recorrer" style="background-color: #fff;">
        <div class="container ">
          ...
          <div class="row imagenes-catalogo icono">
            <?php query_posts(array('post_type' => 'post','lang' => 'pt','posts_per_page' => 3,'category_name' => 'tours-de-som-portugues'));  
          ...
          <div class="row d-flex justify-content-center contenedor-boton-central" style="padding-top: 1.6875rem; padding-bottom: 3rem;">
            <div class="col-12  text-center boton-central">
              <a href="/pt/tours-de-som/" style="color: white !important;">Veja todos os tours de som</a>
            </div>        
          </div>
        </div>
      </section>
