        ...
        <div class="container-fluid catalogo-museos">
          <div class="container">
            ...
            <div class="row imagenes-catalogo">
              <?php query_posts(array('post_type' => 'post','lang' => 'en','category_name' => 'virtual-tours','posts_per_page' => 3)); 
              $postCount=0;
            ...
            <div class="row d-flex justify-content-center contenedor-boton-central" style="padding-top: 1.6875rem; padding-bottom: 3rem;">
              <div class="col-12  text-center boton-central">
                <a href="/virtual-tours/" style="color: white !important;">See all virtual tours</a>
              </div>        
            </div>
          </div>
        </div>
      ...
      <section id="como-recorrer" style="background-color: #fff;">
        <div class="container ">
          ...
          <div class="row imagenes-catalogo icono">
            <?php query_posts(array('post_type' => 'post','lang' => 'en','posts_per_page' => 3,'category_name' => 'sound-tour-english')); 
          ...
          <div class="row d-flex justify-content-center contenedor-boton-central" style="padding-top: 1.6875rem; padding-bottom: 3rem;">
            <div class="col-12  text-center boton-central">
              <a href="/en/sound-tours/" style="color: white !important;">See all sound tours</a>
            </div>        
          </div>
        </div>
      </section>
      <?php query_posts(array('post_type' => 'eventos','lang' => 'en','posts_per_page' => -1));?>
      <?php if (0 && (have_posts())) :  ?>   
    ...
    <?php get_footer( 'ingles'); ?><!-- NOTA Solo agregar el nombre despues de la palabra footer, es decir, el archivo es footer-ingles.php solo agregar ingles en el parametro-->
