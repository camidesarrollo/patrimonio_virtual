    <?php /* Template Name: Recorridos Ingles */ ?>
    <?php get_header('ingles'); ?>
    <!-- CONTENIDO RECORRIDOS-INGLES.PHP -->
    <div id="main">
        ...
        <div class="container-fluid catalogo-museos">
          <div class="container">
            <div class="row container-titulo">
              <div class="col-12">
                <h1>Catalog</h1>
                <p class="bajada">Select your museum to listen to its audio guide</p>
              </div>
            </div>
            <div class="row imagenes-catalogo icono">
              <?php query_posts(array('post_type' => 'post', 'lang' => 'en', 'posts_per_page' => 6, 'category_name' => 'sound-tour-english'));
