          ...
          <div class="col-lg-6">
            <div class="row container-logo">
              ...
              <div class="col-lg-7 d-flex align-items-end">
                <a href="/fr/patrimonio-virtual-francais/" style="text-decoration:none;">
                  <div class="complemento-logo">Patrimoine virtuel</div>
                </a>
              </div>
            </div>
          </div>
          <div class="col-lg-4 d-flex align-items-center justify-content-center">
            <div class="container-search">
              <div class="input-group md-form form-sm form-2 pl-0 ">
                <!--Bug Fix 2221 !-->
                <input id="buscador" class="form-control my-auto py-1 search-box" type="text" placeholder="Recherche..." aria-label="Recherche">
        ...
        <div class="row">
          <div class="col-10  d-flex align-items-center justify-content-start">
            <div class="container-search">
              <!--Bug Fix 2221 !-->
              <div class="input-group md-form form-sm form-2 pl-0 ">
                <input id="buscador-mob" class="form-control my-auto py-1 search-box" type="text" placeholder="Recherche..." aria-label="Recherche">
                <div class="input-group-append">
