    ...
    jQuery.ajax({
        ...
        if (data == 'true') {
            ...
            if (jQuery('#tipoIden_persona').val() === 'R') {
                valText.push('Ya existe una cuenta asociada al rut ingresado, <a href="/ingreso-pat-virtual/">inicia sesión aquí</a>');
            } else {
                valText.push('Ya existe una cuenta asociada al Pasaporte / DNI ingresado, <a href="/ingreso-pat-virtual/">inicia sesión aquí</a>');
            }
            ...
            validacion = false;
            rutValido(false);
            valText.push('La identificación ya se encuentra registrada, favor valida tu cuenta e <a href="/ingreso-pat-virtual/">inicia sesión</a>');
        } else {
            if (jQuery('#tipoIden_persona').val() === 'R') {
